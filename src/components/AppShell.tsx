...
const NAV = [
  ...
  { href: '/post-discharge', label: 'Post-Discharge', roles: ['admin', 'manager', 'agent'] },
  { href: '/complications', label: 'Complications', roles: ['admin', 'manager', 'agent'] },
  { href: '/nps', label: 'NPS', roles: ['admin', 'manager'] },
  { href: '/loyalty', label: 'Loyalty', roles: ['admin', 'manager'] },
